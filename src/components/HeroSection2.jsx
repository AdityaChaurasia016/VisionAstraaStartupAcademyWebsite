  ...
  return (
    <div className=' bg-cover p-2 lg:p-12 text-white'>
        ...
        <div className=' flex lg:w-1/2 h-full p-2 lg:p-12 bg-[white]/10 backdrop-blur-md rounded-xl'>
            <p className='text-center text-[13px] lg:text-2xl font-light lg:trcking-wide'>We specialize in providing cutting-edge AI solutions designed to meet the unique needs of various higher 
