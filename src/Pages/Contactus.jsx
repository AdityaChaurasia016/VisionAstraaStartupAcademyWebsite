    ...
    <div>
     <div className="max-w-full mx-auto pt-10 bg-[url('src/assets/newbg2.jpg')] bg-cover">
        ...
        <div className='flex flex-col lg:flex-row lg:h-[40rem] p-3 lg:p-12'>
          ...
          <div className='lg:w-1/2 bg-[#6CB2EB]/10 backdrop-blur-xl text-white lg:p-12 p-4'>
            ...
            <div className='flex flex-col mt-10 space-y-8 '>
              <div className='flex lg:flex-row flex-col lg:space-x-6 lg:space-y-0 space-y-3'>
                ...
                <p className=' text-sm tracking-wide lg:text-justify text-left lg:w-[400px]'>Connect with us on LinkedIn for industry insights, networking opportunities, and updates on our
              ...
              <div className='flex lg:flex-row flex-col lg:items-center lg:space-x-6 lg:space-y-0 space-y-3'>
                ...
                <p className=' text-sm tracking-wide text-justify lg:w-[400px]'>Be the first on your block to get startup updates, announcements, news and lots of really good content, like us on Facebook today!</p>
              </div>
              <div className='flex space-x-1 lg:items-center lg:flex-row flex-col lg:space-y-0 space-y-3'>
                <a href="INSTAGRAM URL" target="_blank" rel="noopener noreferrer">
                  <img src={Instagram} alt="Instagram" className='w-[80px] h-[70px] ml-[-10px]' />
                </a>
